...
class Trianglify(forms.Form):
    ...
    x_gradient = forms.CharField(min_value=0, max_value=1,
                                 label='x gradient', required=False)
    y_gradient = forms.CharField(min_value=0, max_value=1,
                                 label='y gradient', required=False)
